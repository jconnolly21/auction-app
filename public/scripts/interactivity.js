...
function updateDraftLog(data) {
	...
	htmlString += '<tr><th scope="row">' + data.draftnumber + '.</th><td>' + printName + ' <span class="teamname">(' + data.team + ')</span></td><td class="column-center pos- ' + data.rosterspot + '">' + data.rosterspot + '</td><td class="column-right">$' + data.price + '</td></tr>';
